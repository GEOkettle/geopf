import{r as a,b as l,i as s,j as r,u as t}from"./index-CdcQ8Wz3.js";import{N as d}from"./styles-CcShdLyf.js";import"./Frame-DXiApbQH.js";const f=()=>{const[o,c]=a.useState(null),{inApp:n}=l();return a.useEffect(()=>{n&&s.get("/notion/contact").then(e=>{const i=e.data.recordMap;c(i)}).catch(e=>console.error(e))},[n]),r.jsx(r.Fragment,{children:r.jsx(p,{children:r.jsx(x,{children:o?r.jsx(d,{disableHeader:!0,darkMode:!0,recordMap:o,fullPage:!0}):r.jsx("div",{style:{height:"100%",display:"flex",justifyContent:"center",alignItems:"center"},children:r.jsx(u,{})})})})})},p=t.div`
  display: flex;
  height: 90%;
  color: white;
`,x=t.div`
