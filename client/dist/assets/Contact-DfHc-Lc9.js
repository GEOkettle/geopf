import{r as c,b as p,i as u,j as r,u as i}from"./index-aCAAJena.js";import{N as g}from"./styles-D1FvzIrd.js";import"./Frame-Cz-m9U1h.js";const C=()=>{const[e,d]=c.useState(null),{inApp:s,isDarkMode:l}=p();return c.useEffect(()=>{s&&u.get("/notion/contact").then(o=>{const t=o.data.recordMap;d(t)}).catch(o=>console.error(o))},[s]),c.useEffect(()=>{setTimeout(()=>{const o=document.getElementsByClassName("notion-page"),t=document.getElementsByClassName("notion-page-scroller");if(o&&t){let n,a;for(n=0;n<o.length;n++)l?o[n].style.background=" rgba(23, 23, 32,0.4)":o[n].style.background="none";for(a=0;a<t.length;a++)l?t[a].style.background="rgba(23, 23, 32,0.4)":t[a].style.background="none"}},500)}),r.jsx(r.Fragment,{children:r.jsx(x,{children:r.jsx(b,{children:e?r.jsx(g,{disableHeader:!0,darkMode:!!l,recordMap:e,fullPage:!0}):r.jsx("div",{style:{height:"100%",display:"flex",justifyContent:"center",alignItems:"center"},children:r.jsx(f,{})})})})})},x=i.div`
  display: flex;
  height: 90%;
  color: white;
`,b=i.div`
